...
import org.jfm.event.FileListSelectionEvent;
...
public class Options {
	...
	/**
	 * The key that is used to save the user's preference on what the right panel
	 * should be
	 */
	...
	/**
	 * The key that is used to save the user's preference on the default baracuda
	 * URL to use
	 */
	...
	public static void setForegroundColor(Color c) {
		getPreferences().put("JFM.foregroundcolor",
	...
	public static void setBackgroundColor(Color c) {
		getPreferences().put("JFM.backgroundcolor",
				c.getRed() + "," + c.getGreen() + "," + c.getBlue() + "," + c.getAlpha());
	}

	public static void setMarkedColor(Color c) {
		getPreferences().put("JFM.markedcolor",
				c.getRed() + "," + c.getGreen() + "," + c.getBlue() + "," + c.getAlpha());
	}
